...
@Component({
  selector: 'app-relatorio-movimentacao-por-entrada',
  templateUrl: './movimentacao-por-entrada.component.html',
  styleUrls: ['../almoxarifado.component.scss'],
})
export class RelatorioMovimentacaoPorEntradaComponent implements OnInit {
  constructor(
  ...
  filtrar() {
    ...
    this.relatorioAlmoxarifado.movimentacaoEntradaMaterial(relatorioMovimentacaoEntrada).subscribe({
      next: (res) => {
