...
@Component({
  selector: 'app-relatorio-movimentacao-por-saida-excel',
  templateUrl: './movimentacao-por-saida-excel.component.html',
})
export class RelatorioMovimentacaoPorSaidaExcelComponent implements OnInit {
  constructor(
  ...
  filtrar() {
    ...
    this.relatorioAlmoxarifado.movimentacaoSaidaMaterialExcel(relatorioMovimentacaoSaida).subscribe({
      next: (res) => {
