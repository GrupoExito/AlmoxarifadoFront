...
export class CredenciamentoProcessoAdministrativoService {
  baseURL = `${environment.apiLegacyUrl}/contratacaoprocessoadministrativo`;
  constructor(private http: HttpClient) {}

  criar(contratacaoCredenciamento: ContratacaoPA): Observable<ContratacaoPA> {
    return this.http.post<ContratacaoPA>(`${this.baseURL}`, contratacaoCredenciamento);
  }
