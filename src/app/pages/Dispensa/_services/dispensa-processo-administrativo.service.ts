...
export class DispensaProcessoAdministrativoService {
  baseURL = `${environment.apiLegacyUrl}/contratacaoprocessoadministrativo`;
  constructor(private http: HttpClient) {}

  criar(contratacaoDispensa: ContratacaoPA): Observable<ContratacaoPA> {
    return this.http.post<ContratacaoPA>(`${this.baseURL}`, contratacaoDispensa);
  }
