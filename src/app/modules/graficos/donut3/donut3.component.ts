...
@Component({
  selector: 'app-donut3',
  templateUrl: './donut3.component.html',
})
...
const initChart = function (chartSize: number = 70, chartLine: number = 11, chartRotate: number = 145) {
  const el = document.getElementById('kt_donut3_chart');
  if (!el) {
    return;
  }
  ...
  drawCircle('#1035de', options.lineWidth, 100 / 150);
  drawCircle('#de1024', options.lineWidth, 100 / 250);
};
